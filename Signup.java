...
public class Signup extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String fname = request.getParameter("input3");
		  ...
		  String addr = request.getParameter("input5");
		  String dob = request.getParameter("input6");
		  String email = request.getParameter("input7");
		  
		  if (fname.isEmpty() || username.isEmpty() || password.isEmpty() || lname.isEmpty() || addr.isEmpty() || dob.isEmpty() || email.isEmpty()) {
